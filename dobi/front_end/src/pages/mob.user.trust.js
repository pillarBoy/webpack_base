...
// mobile
import "@/styles/mob/user.trust.scss";
...
$(document).ready(function() {
  ...
  // 条件筛选
  $("#conditionflag").on("touchend", function(e) {
    if (isScrollMove) return;
    // $("#condList").show();
    if ($("#condList").is(":visible")) {
      $("#condList").hide();
    } else {
      $("#condList").show();
    }
  ...
  //
  $("#condList").on("touchmove", function() {
    isScrollMove = true;
  });
  //
  // $("#condList span").on("touchend", function() {
  //   let type = $(this).html();
  //   $("#conditionflag").html(type);
  //   isScrollMove = false;
  // });
  $("#coinFlag span[data-flag]").on("touchend", function() {
    if (isScrollMove) return;
    $("#condList").hide();
    let $this = $(this);
    let type = $this.html();
  ...
  $("#coinFlag span[data-flag]").on("touchstart", function() {
    isScrollMove = false;
  });

  $("#coinList").on("touchstart", function() {
    isScrollMove = false;
  });
  // 条件筛选
  $("#coinList").on("touchmove", function(e) {
    isScrollMove = true;
  });

  // 幣篩選條件
  $('#coinList span[data-coincode]').on('touchend', function() {
    if (isScrollMove) return;
